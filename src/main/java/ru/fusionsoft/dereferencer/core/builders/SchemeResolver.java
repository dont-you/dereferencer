...
public class SchemeResolver {
    ...
    public JsonNode dereferenceResolve(JsonNode node)
            throws JsonMappingException, JsonProcessingException, ReferenceException {
    ...
    public JsonNode mergeResolve(JsonNode node)
            throws JsonMappingException, JsonProcessingException, ReferenceException {
        JsonNode result = Dereferencer.objectMapper.readTree("{}");
