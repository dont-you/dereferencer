...
public class DereferencerTest {
    ...
    @Test
    public void Test_simple_merge_scheme() throws StreamReadException, DatabindException, ReferenceException, IOException, URISyntaxException {
        JsonNode actual = Dereferencer.dereference("./src/test/resources/test-schemes/schemes/simple_merge_scheme.json");
        JsonNode expected = mapper.readTree(Paths.get("./src/test/resources/test-schemes/expected-result/dereferenced_simple_merge_scheme.json").toFile());
